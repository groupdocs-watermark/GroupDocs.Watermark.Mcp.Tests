...
# Run all integration tests against the default package version (25.6.0)
dotnet test -c Release

# Run against a specific published version
dotnet test -c Release -p:McpPackageVersion=25.6.0
# or
MCP_PACKAGE_VERSION=25.6.0 dotnet test -c Release
