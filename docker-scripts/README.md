...
./02_test-all-scenarios.sh --version 25.6.0
...
Options:
  --version VERSION       Test specific package version (default: latest)
                          ...
                          stable release. Pin (e.g. "25.6.0") for reproducible
                          / shared / CI runs.
...
Examples:
  ...
  # Pin to 25.6.0 with custom license
  ./02_test-all-scenarios.sh --version 25.6.0 --license /path/to/lic
...
```bash
for version in 26.4.3 25.6.0 26.5.0 latest; do
