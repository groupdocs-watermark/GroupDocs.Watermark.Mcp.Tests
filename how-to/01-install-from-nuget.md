...
(
  ...
  sleep 2
) | GROUPDOCS_MCP_STORAGE_PATH=./docs dnx GroupDocs.Watermark.Mcp@25.6.0 --yes
```
...
```text
initialize response → serverInfo: { name: "GroupDocs.Watermark.Mcp", version: "25.6.0" }
```
